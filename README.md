...
If you want to the user to move a certain threshold to drag, add a config object to the page before you include the shim.

```html
<script>
var iosDragDropShim = { offsetToDrag: 30 } //Adds 30px offset before dragging
</script>
<script src="vendor/ios-drag-drop.js"></script>
```
